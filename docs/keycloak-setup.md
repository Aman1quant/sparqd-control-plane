...
### 1.1 Login as kcadmin
- Login using username=`kcadmin` and password=`kcadmin`.

### 1.2 Change current realm into global-users
...
### 1.3 Verify global-users Realm Settings
- On the left navigation bar, click on **Realm settings**

#### 1.3.1 Verify Realm Login
...
#### 1.4.1 Verify registration email otp
...
### 1.5 Verify and update Github login
